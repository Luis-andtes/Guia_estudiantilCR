        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="notion-card cursor-pointer group h-full flex flex-col" onClick={() => setActiveSection("mapa")}>
              ...
              <Card className="notion-card cursor-pointer group h-full flex flex-col" onClick={() => setActiveSection("guia")}>
                <CardHeader className="text-center pb-4 flex-shrink-0">
                  <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-primary/20 transition-colors">
              ...
              <Card className="notion-card cursor-pointer group h-full flex flex-col" onClick={() => setActiveSection("horarios")}>
                <CardHeader className="text-center pb-4 flex-shrink-0">
                  <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-primary/20 transition-colors">
